...
//        // Act
//        Juego Escalera = Juego.chequearJuego(new ArrayList<>(List.of( new Carta(1, new Trebol()),
//                new Carta(2, new Trebol()), new Carta(3, new Corazon()),
//                new Carta(4, new Trebol()), new Carta(5, new Trebol()) )));
//        Puntaje puntajeObtenido = Escalera.puntuarMano(new ArrayList<>(List.of(new Carta(1, new Trebol()),
//                new Carta(2, new Trebol()), new Carta(3, new Corazon()),
//                new Carta(4, new Trebol()), new Carta(5, new Trebol()))));
//        // Assert
