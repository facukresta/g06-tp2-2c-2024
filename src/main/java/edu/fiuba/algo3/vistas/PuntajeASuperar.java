...
public class PuntajeASuperar implements Observador {
    ...
    public PuntajeASuperar(HBox contenedor) {
    ...
    public void actualizar(Object notificador) {
        ...
        Label puntajeASuperarMostrado = this.creadorDeEtiqueta.crearEtiquetaConEstilo(String.valueOf(ronda.obtenerPuntajeASuperar()), "-fx-font-size: 24px; -fx-text-fill: white;");
